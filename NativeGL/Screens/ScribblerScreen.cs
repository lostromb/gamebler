...
namespace NativeGL.Screens
{
    public class ScribblerScreen : GameScreen
    {
        ...
        protected override void RenderInternal()
        {
            ...
            _drawing.Print(_headerFont, "SCRIBBLER", new Vector3(InternalResolutionX / 2, InternalResolutionY - sidePadding, 0), maxWidth, QFontAlignment.Centre, _renderOptions);
            _drawing.Print(_questionFont, "Draw a picture of the given gospel topic on the board. Points are awarded if the class can guess correctly what you are drawing. Teacher will provide the prompt", new Vector3(sidePadding, InternalResolutionY - 250, 0), maxWidth, QFontAlignment.Justify, _renderOptions);
