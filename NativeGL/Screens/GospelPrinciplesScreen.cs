...
{
    public class GospelPrinciplesScreen : GameScreen
    {
        ...
        private PrincipleQuestion _currentQuestion;
        ...
        protected override void RenderInternal()
        {
            ...
            _drawing.Print(_questionFont, builder.ToString(), new Vector3(sidePadding, InternalResolutionY - 250, 0), maxWidth, QFontAlignment.Left, _renderOptions);
        ...
        public override void ScreenAboveFinished(GameScreen aboveScreen)
        {
            if (aboveScreen is DifficultySelectScreen)
            {
                ...
                GameState.GospelPrincipleQuestions.Remove(_currentQuestion);
