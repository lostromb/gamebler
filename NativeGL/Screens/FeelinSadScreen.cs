...
namespace NativeGL.Screens
{
    public class FeelinSadScreen : GameScreen
    {
        ...
        protected override void RenderInternal()
        {
            ...
            _drawing.Print(_questionFont, "Current player loses 100 points", new Vector3(sidePadding, InternalResolutionY - 250, 0), maxWidth, QFontAlignment.Justify, _renderOptions);
