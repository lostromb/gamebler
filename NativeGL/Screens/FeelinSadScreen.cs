...
{
    public class FeelinSadScreen : GameScreen
    {
        ...
        protected override void RenderInternal()
        {
            ...
            _drawing.Print(_headerFont, "Feelin' Sad", new Vector3(InternalResolutionX / 2, InternalResolutionY - sidePadding, 0), maxWidth, QFontAlignment.Centre, _renderOptions);
            _drawing.Print(_questionFont, "Current player loses 150 points", new Vector3(sidePadding, InternalResolutionY - 250, 0), maxWidth, QFontAlignment.Justify, _renderOptions);
