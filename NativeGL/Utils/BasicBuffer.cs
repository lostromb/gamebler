...
namespace Durandal.Common.Utils.IO
{
    public class BasicBuffer<T>
    {
        ...
        public void Write(T[] toWrite)
        {
            ...
            {
                int count = System.Math.Min(toWrite.Length - sourceIndex, capacity - writeIndex);
        ...
        public T[] Read(int count)
        {
            ...
            {
                int readCount = System.Math.Min(count - sourceIndex, capacity - readIndex);
        ...
        public T[] Peek(int count)
        {
            ...
            {
                int readCount = System.Math.Min(toRead - sourceIndex, capacity - localReadIndex);
